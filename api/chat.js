...
- /work.html — the portfolio: nine finished builds across nine trades, openable and scrollable. The tattoo studio at the top is a LIVE CLIENT SITE (wahlahlahlahstudios, a real private studio in Long Island City) and is Signature tier — lead with it, it is the strongest proof on the site. Second is the PRODUCT SHOWCASE (/demo-product.html), also Signature tier: a scroll-driven page where the product materialises, turns, reveals its specs and lands on a buy button. It uses a banana as a deliberate placeholder — point anyone who sells a physical product, a brand, a maker or a shop at it, because one image and one config block make it their product. The auto body and pest control builds are also Signature tier. Everything except the tattoo studio is a demo built on a fictional business or a placeholder product — say so if asked, and never imply the demos are real clients.
