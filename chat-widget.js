...
(function () {
  ...
  /* ---------- styles ---------- */
  var css = [
    '#uidc-bubble{position:fixed;bottom:84px;right:16px;z-index:9999;width:56px;height:56px;border-radius:50%;background:#0B0F14;border:2px solid #3B82F6;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 6px 20px rgba(59,130,246,.35);transition:transform .15s;font-size:24px;line-height:1}',
    ...
    '#uidc-head{background:#0B0F14;color:#F4F6F8;padding:14px 16px;display:flex;align-items:center;justify-content:space-between;flex-shrink:0;border-bottom:2px solid #3B82F6}',
    '#uidc-head strong{font-size:17px;display:block;font-family:"Playfair Display",Georgia,serif}',
    '#uidc-head small{display:block;font-size:12px;color:#D5DBE1;font-weight:400}',
    '#uidc-close{background:none;border:none;color:#F4F6F8;font-size:26px;line-height:1;cursor:pointer;padding:6px 10px;min-height:44px}',
    '#uidc-msgs{flex:1;overflow-y:auto;padding:16px;display:flex;flex-direction:column;gap:10px;background:#F4F6F8}',
    ...
    '.uidc-bot{background:#FFFFFF;color:#0B0F14;border:1px solid #D5DBE1;border-bottom-left-radius:4px;align-self:flex-start}',
    '.uidc-user{background:#2563EB;color:#fff;border-bottom-right-radius:4px;align-self:flex-end}',
    '.uidc-sms{display:inline-flex;align-items:center;justify-content:center;min-height:48px;background:#2563EB;color:#fff;font-weight:700;font-size:15px;text-decoration:none;border-radius:8px;padding:12px 18px;align-self:flex-start;margin-top:2px}',
    '#uidc-typing{display:none;align-self:flex-start;padding:12px 16px;background:#FFFFFF;border:1px solid #D5DBE1;border-radius:14px;border-bottom-left-radius:4px}',
    '#uidc-typing span{display:inline-block;width:7px;height:7px;border-radius:50%;background:#2563EB;margin:0 2px;animation:uidcB 1.2s infinite}',
    ...
    '#uidc-form{display:flex;gap:8px;padding:12px;background:#FFFFFF;border-top:1px solid #D5DBE1;flex-shrink:0}',
    '#uidc-input{flex:1;padding:12px 14px;border:1px solid #D5DBE1;border-radius:8px;font-size:16px;font-family:inherit;background:#fff;color:#0B0F14}',
    '#uidc-send{min-height:48px;min-width:48px;background:#2563EB;color:#fff;border:none;border-radius:8px;font-size:18px;cursor:pointer;padding:0 16px}'
  ].join('\n');
